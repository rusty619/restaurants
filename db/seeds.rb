...
good_review = Review.create(star_rating: 4, restaurant_id: 1, customer_id: 1)
great_review = Review.create(star_rating: 5, restaurant_id: 2, customer_id: 2)
ok_review = Review.create(star_rating: 3, restaurant_id: 3, customer_id: 3)
bad_review = Review.create(star_rating: 2, restaurant_id: 2, customer_id: 4)
terrible_review = Review.create(star_rating: 1, restaurant_id: 3, customer_id: 5)
